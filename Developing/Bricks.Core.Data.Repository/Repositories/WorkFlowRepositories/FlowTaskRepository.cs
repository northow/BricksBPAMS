...
using Bricks.Core.Data.IRepositories.IWorkFlowRepositories;
using System;
using Autofac;
using AutoMapper;
using System.Linq;
...
namespace Bricks.Core.Data.Repository.Repositories.WorkFlowRepositories
{
                ...
                result.ForEach(a =>
                {
                    ...
                    if (a.ApproveUserName.Contains(','))
                    {
                        ...
                        foreach (var item in cc)
                        {
                            ...
                            var usrmoel = dal.GetRepository<Bricks.Core.Data.Entity.SystemEntity.User>().Get(b => b.UserID == approveid).FirstOrDefault();
                        ...
                        a.ApproveUserName = dal.GetRepository<Bricks.Core.Data.Entity.SystemEntity.User>().Get(b => b.UserID == approveid).FirstOrDefault().UserReallyname;
                    }
